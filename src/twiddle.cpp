...
/**
 * Twiddle algorithm implementation. This function executes in the twiddle worker thread
...
/**
 * Pass CTE signal to twiddle worker thread and wait for processing result. This function executes in the main thread
 * @param cte current cte from simulator
 * @output reset_sim whether to reset the simulator. We will reset the simulator when the testing on a PID is complete
 * or the vehicle crashed
 * @output steering angle value generated by current PID under testing
 */
